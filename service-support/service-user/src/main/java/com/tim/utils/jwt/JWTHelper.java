...
import com.tim.utils.string.StringUtil;
...
public class JWTHelper {
    ...
    public static IJWTInfo getInfoFromToken(String token, String pubKeyPath) throws Exception {
        ...
        return new JWTInfo(body.getSubject(), StringUtil.getObjectValue(body.get(CommonConstants.JWT_KEY_USER_ID)), StringUtil.getObjectValue(body.get(CommonConstants.JWT_KEY_NAME)));
    }
    /**
     * 获取token中的用户信息
     *
